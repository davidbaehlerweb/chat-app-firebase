...
export default function SignIn() {
    ...
    const handleLogin = async () => {
        ...
        // Simule un délai pour l'opération de connexion
            ...
            <View style={{ paddingTop: hp(8), paddingHorizontal: wp(5) }} className="flex-1 gap-12">
                <View className="items-center">
                    <Image
                        style={{ height: hp(25) }}
                        resizeMode='contain'
                        source={require('../assets/images/header_signin.jpg')}
                    />
                </View>
                        ...
                        <View>
                            {
                                loading ? (
                                    ...
                                    <TouchableOpacity
                                        style={{ height: hp(6.5), backgroundColor: '#4f46e5', borderRadius: 15, justifyContent: 'center', alignItems: 'center' }}
                                        onPress={handleLogin}
                                    >
